...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x0f\n\xbe\x01\n\x04\x04\0\x02\0\x12\x03\x0e\x02\x12\x1a\xb0\x01\x20\
    The\x20name\x20given\x20to\x20this\x20operator.\x20Used\x20for\x20naming\
    \x20inputs,\n\x20logging,\x20visualization,\x20etc.\x20\x20Unique\x20wit\
    hin\x20a\x20single\x20GraphDef.\n\x20Must\x20match\x20the\x20regexp\x20\
    ...
    \x10\x11\n\x92\x01\n\x04\x04\0\x02\x01\x12\x03\x12\x02\x10\x1a\x84\x01\
    \x20The\x20operation\x20name.\x20\x20There\x20may\x20be\x20custom\x20par\
    ameters\x20in\x20attrs.\n\x20Op\x20names\x20starting\x20with\x20an\x20un\
    derscore\x20are\x20reserved\x20for\x20internal\x20use.\n\n\r\n\x05\x04\0\
    \x02\x01\x04\x12\x04\x12\x02\x0e\x12\n\x0c\n\x05\x04\0\x02\x01\x05\x12\
    \x03\x12\x02\x08\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\x12\t\x0b\n\x0c\n\
    \x05\x04\0\x02\x01\x03\x12\x03\x12\x0e\x0f\n\xa7\x02\n\x04\x04\0\x02\x02\
    \x12\x03\x19\x02\x1c\x1a\x99\x02\x20Each\x20input\x20is\x20\"node:src_ou\
    tput\"\x20with\x20\"node\"\x20being\x20a\x20string\x20name\x20and\n\x20\
    \"src_output\"\x20indicating\x20which\x20output\x20tensor\x20to\x20use\
    \x20from\x20\"node\".\x20If\n\x20\"src_output\"\x20is\x200\x20the\x20\":\
    0\"\x20suffix\x20can\x20be\x20omitted.\x20\x20Regular\x20inputs\n\x20may\
    \x20optionally\x20be\x20followed\x20by\x20control\x20inputs\x20that\x20h\
    ave\x20the\x20format\n\x20\"^node\".\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\
    \x03\x19\x02\n\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03\x19\x0b\x11\n\x0c\n\
    \x05\x04\0\x02\x02\x01\x12\x03\x19\x12\x17\n\x0c\n\x05\x04\0\x02\x02\x03\
    \x12\x03\x19\x1a\x1b\n\xa1\x06\n\x04\x04\0\x02\x03\x12\x03/\x02\x14\x1a\
    \x93\x06\x20A\x20(possibly\x20partial)\x20specification\x20for\x20the\
    \x20device\x20on\x20which\x20this\n\x20node\x20should\x20be\x20placed.\n\
    \x20The\x20expected\x20syntax\x20for\x20this\x20string\x20is\x20as\x20fo\
    llows:\n\n\x20DEVICE_SPEC\x20::=\x20PARTIAL_SPEC\n\n\x20PARTIAL_SPEC\x20\
    ::=\x20(\"/\"\x20CONSTRAINT)\x20*\n\x20CONSTRAINT\x20::=\x20(\"job:\"\
    \x20JOB_NAME)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20|\
    \x20(\"replica:\"\x20[1-9][0-9]*)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20|\x20(\"task:\"\x20[1-9][0-9]*)\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20|\x20(\"device:\"\x20[A-Za-z]*\
    \x20\":\"\x20([1-9][0-9]*\x20|\x20\"*\")\x20)\n\n\x20Valid\x20values\x20\
    for\x20this\x20string\x20include:\n\x20*\x20\"/job:worker/replica:0/task\
    :1/device:GPU:3\"\x20\x20(full\x20specification)\n\x20*\x20\"/job:worker\
    /device:GPU:3\"\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20(partial\x20specification)\n\x20*\x20\"\"\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20(no\x20s\
    pecification)\n\n\x20If\x20the\x20constraints\x20do\x20not\x20resolve\
    \x20to\x20a\x20single\x20device\x20(or\x20if\x20this\n\x20field\x20is\
    \x20empty\x20or\x20not\x20present),\x20the\x20runtime\x20will\x20attempt\
    \x20to\n\x20choose\x20a\x20device\x20automatically.\n\n\r\n\x05\x04\0\
    \x02\x03\x04\x12\x04/\x02\x19\x1c\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03/\
    \x02\x08\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03/\t\x0f\n\x0c\n\x05\x04\0\
    \x02\x03\x03\x12\x03/\x12\x13\n\x94\x05\n\x04\x04\0\x02\x04\x12\x03=\x02\
    \"\x1a\x86\x05\x20Operation-specific\x20graph-construction-time\x20confi\
    guration.\n\x20Note\x20that\x20this\x20should\x20include\x20all\x20attrs\
    \x20defined\x20in\x20the\n\x20corresponding\x20OpDef,\x20including\x20th\
    ose\x20with\x20a\x20value\x20matching\n\x20the\x20default\x20--\x20this\
    \x20allows\x20the\x20default\x20to\x20change\x20and\x20makes\n\x20NodeDe\
    fs\x20easier\x20to\x20interpret\x20on\x20their\x20own.\x20\x20However,\
    \x20if\n\x20an\x20attr\x20with\x20a\x20default\x20is\x20not\x20specified\
    \x20in\x20this\x20list,\x20the\n\x20default\x20will\x20be\x20used.\n\x20\
    The\x20\"names\"\x20(keys)\x20must\x20match\x20the\x20regexp\x20\"[a-z][\
    a-z0-9_]+\"\x20(and\n\x20one\x20of\x20the\x20names\x20from\x20the\x20cor\
    responding\x20OpDef's\x20attr\x20field).\n\x20The\x20values\x20must\x20h\
    ave\x20a\x20type\x20matching\x20the\x20corresponding\x20OpDef\n\x20attr'\
    s\x20type\x20field.\n\x20TODO(josh11b):\x20Add\x20some\x20examples\x20he\
    re\x20showing\x20best\x20practices.\n\n\r\n\x05\x04\0\x02\x04\x04\x12\
