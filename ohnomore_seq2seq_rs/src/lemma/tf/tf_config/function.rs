...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    low/tensorflow/tensorflow/go/core/framework\xf8\x01\x01J\xf7\"\n\x06\x12\
    ...
    \x0f\"#\n\xf3\x01\n\x02\x04\x01\x12\x04\x18\0N\x01\x1a\xe6\x01\x20A\x20f\
    ...
    \x03\x1e\x20!\nL\n\x03\x04\x01\t\x12\x03!\x0b\r\x1a@\x20NOTE:\x20field\
    \x20id\x202\x20deleted\x20on\x20Jan\x2011,\x202017,\x20GraphDef\x20versi\
    on\x2021.\n\n\x0b\n\x04\x04\x01\t\0\x12\x03!\x0b\x0c\n\x0c\n\x05\x04\x01\
    \t\0\x01\x12\x03!\x0b\x0c\n\x0c\n\x05\x04\x01\t\0\x02\x12\x03!\x0b\x0c\n\
    \xfb\x0e\n\x04\x04\x01\x02\x02\x12\x03I\x02\x20\x1a\x97\x01\x20By\x20con\
    vention,\x20\"op\"\x20in\x20node_def\x20is\x20resolved\x20by\x20consulti\
    ng\x20with\x20a\n\x20user-defined\x20library\x20first.\x20If\x20not\x20r\
    esolved,\x20\"func\"\x20is\x20assumed\x20to\n\x20be\x20a\x20builtin\x20o\
    p.\n2\xad\x0c\x20In\x20both\x20of\x20the\x20following\x20fields,\x20ther\
    e\x20is\x20the\x20need\x20to\x20specify\x20an\n\x20output\x20that\x20is\
    \x20used\x20as\x20either\x20the\x20input\x20to\x20another\x20node\x20(in\
    \n\x20`node_def`)\x20or\x20as\x20a\x20return\x20value\x20of\x20the\x20fu\
    nction\x20(in\x20`ret`).\n\x20Unlike\x20the\x20NodeDefs\x20in\x20GraphDe\
    f,\x20we\x20need\x20to\x20be\x20able\x20to\x20specify\x20a\n\x20list\x20\
    in\x20some\x20cases\x20(instead\x20of\x20just\x20single\x20outputs).\x20\
    \x20Also,\x20we\n\x20need\x20to\x20be\x20able\x20to\x20deal\x20with\x20l\
    ists\x20of\x20unknown\x20length\x20(so\x20the\n\x20output\x20index\x20ma\
    y\x20not\x20be\x20known\x20at\x20function\x20definition\x20time).\x20\
    \x20So\n\x20we\x20use\x20the\x20following\x20format\x20instead:\n\x20*\
    \x20\"fun_in\"\x20where\x20\"fun_in\"\x20is\x20the\x20name\x20of\x20a\
    \x20function\x20input\x20arg\x20in\n\x20\x20\x20the\x20`signature`\x20fi\
    eld\x20above.\x20\x20This\x20represents\x20that\x20input,\x20whether\n\
    \x20\x20\x20it\x20is\x20a\x20single\x20tensor\x20or\x20a\x20list.\n\x20*\
    \x20\"fun_in:0\"\x20gives\x20the\x20first\x20element\x20of\x20a\x20funct\
    ion\x20input\x20arg\x20(a\n\x20\x20\x20non-list\x20input\x20is\x20consid\
    ered\x20a\x20list\x20of\x20length\x201\x20for\x20these\n\x20\x20\x20purp\
    oses).\n\x20*\x20\"node:out\"\x20where\x20\"node\"\x20is\x20the\x20name\
    \x20of\x20a\x20node\x20in\x20`node_def`\x20and\n\x20\x20\x20\"out\"\x20i\
    s\x20the\x20name\x20one\x20of\x20its\x20op's\x20output\x20arguments\x20(\
    the\x20name\n\x20\x20\x20comes\x20from\x20the\x20OpDef\x20of\x20the\x20n\
    ode's\x20op).\x20This\x20represents\x20that\n\x20\x20\x20node's\x20outpu\
    t,\x20whether\x20it\x20is\x20a\x20single\x20tensor\x20or\x20a\x20list.\n\
    ...
    \x02\x04\x12\x03I\x02\n\n\x0c\n\x05\x04\x01\x02\x02\x06\x12\x03I\x0b\x12\
    \n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03I\x13\x1b\n\x0c\n\x05\x04\x01\
    \x02\x02\x03\x12\x03I\x1e\x1f\n\x8c\x01\n\x04\x04\x01\x02\x03\x12\x03M\
    ...
    \x05\x04\x01\x02\x03\x04\x12\x04M\x02I\x20\n\x0c\n\x05\x04\x01\x02\x03\
    \x06\x12\x03M\x02\x15\n\x0c\n\x05\x04\x01\x02\x03\x01\x12\x03M\x16\x19\n\
    \x0c\n\x05\x04\x01\x02\x03\x03\x12\x03M\x1c\x1d\n\xfb\x05\n\x02\x04\x02\
    \x12\x04b\0e\x01\x1a\xee\x05\x20GradientDef\x20defines\x20the\x20gradien\
    ...
    \n\n\n\n\x03\x04\x02\x01\x12\x03b\x08\x13\n!\n\x04\x04\x02\x02\0\x12\x03\
    c\x02\x1b\"\x14\x20The\x20function\x20name.\n\n\r\n\x05\x04\x02\x02\0\
    \x04\x12\x04c\x02b\x15\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03c\x02\x08\n\
    \x0c\n\x05\x04\x02\x02\0\x01\x12\x03c\t\x16\n\x0c\n\x05\x04\x02\x02\0\
    \x03\x12\x03c\x19\x1a\n,\n\x04\x04\x02\x02\x01\x12\x03d\x02\x1b\"\x1f\
    \x20The\x20gradient\x20function's\x20name.\n\n\r\n\x05\x04\x02\x02\x01\
    \x04\x12\x04d\x02c\x1b\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\x03d\x02\x08\
    \n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03d\t\x16\n\x0c\n\x05\x04\x02\x02\
    \x01\x03\x12\x03d\x19\x1ab\x06proto3\
";
